...
exports.restoreTabularSectionStructure = exports.restoreAttributeStructure = exports.restorePropertiesStructure = exports.deepClone = void 0;
/**
 ...
 */
function processStandardAttributeItem(item) {
 ...
 */
function restorePropertiesStructure(normalized, original) {
    if (!original) {
        ...
        for (const [key, value] of Object.entries(normalized)) {
            if (typeof value === 'string' || typeof value === 'number' || typeof value === 'boolean') {
                ...
                if (key === 'StandardAttributes' && value.length > 0) {
                    result[key] = {
                        "xr:StandardAttribute": value.map((item) => {
            ...
            if (typeof value === 'string' || typeof value === 'number' || typeof value === 'boolean') {
                ...
                if (key === 'StandardAttributes' && value.length > 0) {
                    ...
                    if (originalValue !== undefined &&
                        ...
                        restored[key] = {
                            [standardAttrKey]: itemsArray.map((item) => processStandardAttributeItem(item))
                        };
                    }
                    else {
                ...
                const allSimpleOrEmpty = Object.values(value).every(v => typeof v === 'string' || typeof v === 'number' || typeof v === 'boolean' ||
    ...
    for (const [key, value] of Object.entries(normalized)) {
        ...
        if (value === "" || value === null || value === undefined) {
            ...
            if (originalValue !== undefined &&
                ...
                const hasAttributes = Object.keys(originalValue).some(k => k.includes(':') || k.startsWith('@') || k === 'xsi:nil' || k === 'nil');
        ...
        // Всегда преобразуем простые значения в элементы с #text
            ...
            if (key === 'StandardAttributes' && value.length > 0) {
                ...
                if (originalValue !== undefined &&
                    ...
                    const standardAttrKey = originalValue["xr:StandardAttribute"] ? "xr:StandardAttribute" :
                        (originalValue["StandardAttribute"] ? "StandardAttribute" : "xr:StandardAttribute");
                    restored[key] = {
                        [standardAttrKey]: value.map((item) => {
                            if (typeof item === 'string' || typeof item === 'number' || typeof item === 'boolean') {
                                return { "#text": String(item) };
                            }
            ...
            if (Array.isArray(value) && value.length > 0) {
                ...
                restored[key] = {
                    [standardAttrKey]: originalValue.map((item) => processStandardAttributeItem(item))
                };
            }
...
exports.restorePropertiesStructure = restorePropertiesStructure;
/**
 * Восстанавливает структуру реквизита из исходного объекта
 */
function restoreAttributeStructure(normalizedAttr, originalAttr, formatTypeToXmlValue) {
    if (!originalAttr) {
    ...
    for (const [key, value] of Object.entries(originalProps)) {
        ...
        if (complexPropertyKeys.includes(key))
            continue;
        ...
        if (key !== "Name" && key !== "name" && key !== "Type" && normalizedProps[key] === undefined) {
            ...
            if (typeof value === 'string' || typeof value === 'number' || typeof value === 'boolean') {
                ...
                if (key === 'StandardAttributes' && value.length > 0) {
                    props[key] = {
                        "xr:StandardAttribute": value.map((item) => processStandardAttributeItem(item))
                    };
                }
                else {
    ...
    if (typeValue && typeof typeValue === 'object' && typeValue["OneOf"]) {
        ...
        props.Type = {
            OneOf: {
                Type: (typeValue["OneOf"]["Type"] || []).map((t) => {
        ...
        if (originalType["OneOf"]) {
            ...
            if (typeValue && typeof typeValue === 'object' && typeValue["OneOf"]) {
                ...
                props.Type.OneOf = {
                    Type: (typeValue["OneOf"]["Type"] || []).map((t, idx) => {
            ...
            if (Array.isArray(originalType["v8:Type"])) {
                ...
                props.Type = {
                    "v8:Type": originalType["v8:Type"].map((t) => {
                        if (typeof t === 'string') {
                            return { "#text": t };
                        }
    ...
    for (const [key, value] of Object.entries(normalizedProps)) {
        ...
        if (value === "" || value === null || value === undefined) {
            ...
            if (originalPropValue !== undefined &&
                ...
                const hasAttributes = Object.keys(originalPropValue).some(k => k.includes(':') || k.startsWith('@') || k === 'xsi:nil' || k === 'nil');
        ...
        if (typeof value === 'string' || typeof value === 'number' || typeof value === 'boolean') {
            ...
            // Edge case: Элемент с xsi:nil
                ...
                if (originalPropValue !== undefined &&
                    ...
                    const hasAttributes = Object.keys(originalPropValue).some(k => k.includes(':') || k.startsWith('@') || k === 'xsi:nil' || k === 'nil' || k === 'xsi:type');
                    if (hasAttributes) {
...
exports.restoreAttributeStructure = restoreAttributeStructure;
/**
 * Восстанавливает структуру табличной части из исходного объекта
 */
function restoreTabularSectionStructure(normalizedTS, originalTS, formatTypeToXmlValue) {
    if (!originalTS) {
        // Создаем новую структуру
        const props = { Name: normalizedTS.name };
        const childObjects = { Attribute: [] };
    ...
    if (originalTS?.InternalInfo) {
        ...
        if (internalInfo["xr:GeneratedType"]) {
            const generatedTypes = Array.isArray(internalInfo["xr:GeneratedType"]) ?
                ...
                [internalInfo["xr:GeneratedType"]];
            internalInfo["xr:GeneratedType"] = generatedTypes.map((gt) => {
                const processed = { ...gt };
...
exports.restoreTabularSectionStructure = restoreTabularSectionStructure;
//# sourceMappingURL=xmlStructureUtils.js.map