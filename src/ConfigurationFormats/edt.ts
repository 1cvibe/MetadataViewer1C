						...
						for (const [indexOfObjects, obj] of objects.entries()) {
							...
							const objNameForFilter = typeof obj === 'string'
								...
								: (obj && typeof obj === 'object'
									? (obj as any).ref ?? (obj as any).$_ref ?? (obj as any).name ?? (obj as any)['#text'] ?? (obj as any).value ?? (obj as any).text ??
										(Object.keys(obj).length === 1 && typeof (Object.values(obj)[0]) === 'string' ? Object.values(obj)[0] as string : null)
									: null);
