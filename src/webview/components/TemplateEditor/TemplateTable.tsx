...
import { findCellByPosition, getCellFillPattern, extractTextFromTemplateTextData, getEffectiveFormat, getEffectiveFont, getAllNamedAreas, findNamedAreaByPosition, getNamedAreaForRow, getNamedAreaForColumn, getNamedAreasForRow, getNamedAreasForColumn, isCellOnNamedAreaBoundary } from '../../../utils/templateUtils';
...
export const TemplateTable: React.FC<TemplateTableProps> = ({
    ...
    const getRowHeight = React.useCallback((rowIndex: number): string | undefined => {
    ...
    return (
        ...
        >
            ...
            >
                <colgroup>
                    <col style={{ width: '150px' }} /> {/* template-table-named-area-header */}
                    <col style={{ width: '40px' }} /> {/* template-table-row-header */}
